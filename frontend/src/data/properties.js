export const properties = [
  ...
  },
  {
    ...
    amenities: [
      "Marina view", "Ocean view", "Sea view",
      "Bathtub", "Hair dryer", "Cleaning products", "Shampoo", "Conditioner", "Body soap", "Hot water",
      "Washer", "Hangers", "Bed linens", "Iron", "Clothing storage",
      "TV", "Exercise equipment",
      "Crib",
      "Air conditioning", "Heating",
      "Exterior security cameras on property", "Exterior security camera present", "Smoke alarm", "Carbon monoxide alarm", "Fire extinguisher",
      "Wifi",
      "Kitchen", "Space where guests can cook their own meals", "Refrigerator", "Microwave", "Cooking basics", "Pots and pans, oil, salt and pepper", "Dishes and silverware", "Bowls, chopsticks, plates, cups, etc.", "Stove", "Oven", "Hot water kettle", "Toaster", "Blender", "Trash compactor", "Dining table", "Bread maker",
      "Waterfront", "Right next to a body of water", "Beach access", "Guests can enjoy a nearby beach", "Lake access", "Guests can get to a lake using a path or dock", "Private entrance", "Separate street or building entrance",
    ...
    reviews: [
      ...
      { id: 3, name: "Emma L.", rating: 5, date: "2024-01-08", comment: "Perfect for families! The kids loved the play area and pools. Location is fantastic - walking distance to Marina Walk and tram." }
    ],
    policies: {
      cancellation: "Free cancellation for 48 hours. After that, cancel before 3:00 PM on check-in day for a partial refund.",
      houseRules: "No smoking, No pets, No parties or events, Check-in after 3:00 PM, Check-out before 11:00 AM"
  ...
  },
  {
    ...
    highlights: ["Smartlock check-in", "Infinity pool", "Central, walkable location", "Gym", "Terrace with canal views"],
    dtcm: "BUS-URB-YLMCN",
    ...
    sleeping: [
      { room: "Master Bedroom", beds: "1 Queen-size double bed" },
      { room: "Second Bedroom", beds: "1 Queen-size double bed" },
      { room: "Bathroom", beds: "1 full bath" }
    ],
    access: [
      { place: "Dubai Mall", time: "9 minutes by car" },
      { place: "Palm Jumeirah", time: "19 minutes by car" },
      { place: "Burj Al Arab", time: "18 minutes by car" },
      { place: "The Walk JBR", time: "23 minutes by car" },
      { place: "Dubai International Airport (DXB)", time: "18 minutes by car" },
      { place: "Al Maktoum International Airport", time: "44 minutes by car" }
    ],
    rules: [
    ...
    amenities: [
      ...
      "Waterfront", "Right next to a body of water", "Beach access", "Guests can enjoy a nearby beach", "Lake access", "Guests can get to a lake using a path or dock", "Private entrance", "Separate street or building entrance",
      "Patio or balcony", "Outdoor furniture",
      "Free parking on premises", "Shared pool - infinity", "Elevator", "The home or building has an elevator that's at least 52 inches deep and a doorway at least 32 inches wide", "Gym",
      "Long term stays allowed", "Allow stay for 28 days or more", "Self check-in", "Smart lock", "Housekeeping - available at extra cost"
    ],
    ...
    reviews: [
      { id: 1, name: "Sarah M.", rating: 5, date: "2024-01-15", comment: "Amazing location and beautiful apartment. The infinity pool with Dubai skyline views was incredible! The smart lock check-in was so convenient." },
      { id: 2, name: "Ahmed K.", rating: 4, date: "2024-01-10", comment: "Great place to stay. Clean and well-equipped. The infinity pool and gym facilities were excellent. Would definitely book again." },
      { id: 3, name: "Emma L.", rating: 5, date: "2024-01-08", comment: "Perfect for families! The location is fantastic - close to Dubai Mall and other attractions. The apartment was spacious and comfortable." }
    ],
    policies: {
      cancellation: "Free cancellation for 48 hours. After that, cancel before 3:00 PM on check-in day for a partial refund.",
      houseRules: "No smoking, No pets, No parties or events, Check-in after 3:00 PM, Check-out before 11:00 AM"
  ...
  },
  {
    ...
    sleeping: [
      { room: "Master Bedroom", beds: "1 King-size bed" },
      { room: "Second Bedroom", beds: "2 Single beds" },
      { room: "Bathrooms", beds: "2 full baths" }
    ],
    access: [
      { place: "Burj Khalifa", time: "5 min walk" },
      { place: "Dubai Opera", time: "2 min walk" },
      { place: "The Dubai Fountain", time: "5-7 min walk" },
      { place: "The Dubai Mall", time: "6-10 min walk" },
      { place: "Souk Al Bahar", time: "8 min walk" },
      { place: "Dubai Ice Rink", time: "5 min walk" }
    ],
    rules: [
    ...
    amenities: [
      "Bathtub", "Hair dryer", "Shampoo", "Conditioner", "Hot water",
      "Washer", "Hangers", "Bed linens", "Iron", "Safe", "Clothing storage",
      "TV", "Exercise equipment",
      "Air conditioning", "Heating",
      "Smoke alarm", "Carbon monoxide alarm", "Fire extinguisher",
      "Wifi",
      "Kitchen", "Space where guests can cook their own meals", "Refrigerator", "Microwave", "Cooking basics", "Pots and pans, oil, salt and pepper", "Dishes and silverware", "Bowls, chopsticks, plates, cups, etc.", "Stove", "Oven", "Hot water kettle", "Toaster", "Trash compactor", "Dining table",
      "Waterfront", "Right next to a body of water", "Beach access", "Guests can enjoy a nearby beach", "Lake access", "Guests can get to a lake using a path or dock", "Private entrance", "Separate street or building entrance",
      "Patio or balcony", "Outdoor furniture", "Beach essentials", "Beach towels, umbrella, beach blanket, snorkeling gear",
      "Free parking on premises", "Pool", "Elevator", "The home or building has an elevator that's at least 52 inches deep and a doorway at least 32 inches wide", "Gym",
      "Long term stays allowed", "Allow stay for 28 days or more", "Self check-in", "Smart lock", "Housekeeping - available at extra cost"
    ],
    ...
    reviews: [
      { id: 1, name: "Sarah M.", rating: 5, date: "2024-01-15", comment: "Amazing location! Just steps away from Burj Khalifa and Dubai Mall. The apartment was luxurious and the views were incredible!" },
      { id: 2, name: "Ahmed K.", rating: 5, date: "2024-01-10", comment: "Perfect stay in Downtown Dubai. The apartment was elegant and well-equipped. The pool and gym facilities were excellent." },
      { id: 3, name: "Emma L.", rating: 5, date: "2024-01-08", comment: "Absolutely loved this place! The location is unbeatable - walking distance to all major attractions. The apartment was spotless and beautifully decorated." }
    ],
    policies: {
      cancellation: "Free cancellation for 48 hours. After that, cancel before 3:00 PM on check-in day for a partial refund.",
      houseRules: "No smoking, No pets, No parties or events, Check-in after 3:00 PM, Check-out before 11:00 AM"
